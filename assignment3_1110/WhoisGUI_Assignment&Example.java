...
// Assignment 4
// Professor Jung
// This program is know to site's domain, nameserver, and register.
// with Whois.
...
public class WhoisGUI extends JFrame {
	...
	private JPanel initRecordType() {
		...
		//p.add(this.makeRadioButton("NameServer"));
		//p.add(this.makeRadioButton("Registrar"));
	...
	private class Lookup extends SwingWorker<String, Object> {
		...
		protected String doInBackground() throws Exception {
			...
			} /*else if (searchForLabel.equals("Nameserver")) {
				category = Whois.SearchFor.NAMESERVER;
			}*/
